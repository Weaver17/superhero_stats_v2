...
function SelectLabel({
  ...
  return (
    <SelectPrimitive.Label
      ...
      className={cn(
        "text-muted-foreground px-2 py-1.5 text-xs sm:text-sm md:text-base",
        className
      )}
      {...props}
    />
