...
export default function Home() {
  return (
    <>
      <div className="py-6 px-2 bg-[url('../../public/city-backdrop.jpg')] bg-cover bg-no-repeat bg-center  ">
      ...
      <div className=" py-6 px-2 bg-[url('../../public/city-backdrop-2.jpg')] bg-cover bg-no-repeat bg-center">
